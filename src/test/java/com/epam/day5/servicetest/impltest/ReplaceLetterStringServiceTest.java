...
import com.epam.day5.service.impl.ReplaceLetterStringService;
...
public class ReplaceLetterStringServiceTest {

    ReplaceLetterStringService service;
    String line = "The maximum weight for balls is 1.62 ounces, and balls are not permitted!";

    @BeforeClass
    public void setUp() {
        service = new ReplaceLetterStringService();
    }

    @Test
    public void fixTypoInTextPositiveTest() {
        Optional<String> actual = service.fixTypoInText(line, "[Bb]a", "ro");
    ...
    public void replaceLetterByIndexTextPositiveTest() {
        ...
        Optional<String> expected = Optional.of("Th@ ma@imum we@ght fo@ ba@ls is 1.62 ou@ces, an@ ba@ls ar@ no@ pe@mitted! ");
        assertEquals(actual, expected);
    }
    ...
    public void replaceWordsPositiveTest() {
        ...
        Optional<String> expected = Optional.of("assert maximum weight assert balls is 1.62 ounces, assert balls assert assert permitted!");
        assertEquals(actual, expected);
    }
