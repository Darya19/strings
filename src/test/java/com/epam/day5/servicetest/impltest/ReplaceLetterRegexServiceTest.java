...
import com.epam.day5.service.impl.ReplaceLetterRegexService;
...
public class ReplaceLetterRegexServiceTest {

    ReplaceLetterRegexService service;
    String line = "The maximum weight for balls is 1.62 ounces, and balls are not permitted!";

    @BeforeClass
    public void setUp() {
        service = new ReplaceLetterRegexService();
    }
