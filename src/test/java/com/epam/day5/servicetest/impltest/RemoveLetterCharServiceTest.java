...
import com.epam.day5.service.impl.RemoveLetterCharService;
...
public class RemoveLetterCharServiceTest {

    RemoveLetterCharService service;
    String line = "The maximum weight for balls is 1.62 ounces, and balls are not permitted!";

    @BeforeClass
    public void setUp() {
        service = new RemoveLetterCharService();
    }
    ...
    public void removeWordsPositiveTest() {
        ...
        Optional<String> expected = Optional.of("maximum weight balls is  1 . 6 2 ounces , and balls are permitted !  ");
        assertEquals(actual, expected);
    }
