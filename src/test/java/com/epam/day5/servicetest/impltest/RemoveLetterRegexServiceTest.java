...
import com.epam.day5.service.impl.RemoveLetterRegexService;
...
public class RemoveLetterRegexServiceTest {

    RemoveLetterRegexService service;
    String line = "The maximum weight for balls is 1.62 ounces, and balls are not permitted!";

    @BeforeClass
    public void setUp() {
        service = new RemoveLetterRegexService();
    }
